...
function Quiz10({ setBtc }) {
  const questions = [
    ...
    {
      question:
        "Quelle est la différence entre Object.create() et {} en JavaScript ?",
      options: [
    ...
    {
      question:
        "Comment éviter la modification d'une propriété d'objet en JavaScript ?",
      options: [
    ...
    {
      question:
        "Quelle est la sortie de (function() { return this; }).call(10) en JavaScript ?",
      options: ["Number {10}", "object", "undefined"],
      answer: 0,
    },
    {
      question:
        "Comment copier les valeurs d'un objet dans un autre sans conserver les références ?",
      options: [
    ...
    {
      question:
        "Comment faire en sorte qu'une propriété d'un objet ne soit pas énumérable ?",
      options: [
    ...
    {
      question:
        "Quelle est la différence entre une fonction nommée et une fonction anonyme ?",
      options: [
