...
function Quiz6({ setBtc }) {
  const questions = [
    {
      question: "Quelle méthode est utilisée pour vérifier si un tableau inclut un certain élément ?",
      options: ["includes()", "has()", "contains()"],
      answer: 0,
    },
    {
      question: "Comment itérer sur chaque élément d'un tableau en JavaScript ?",
    ...
    {
      question: "Comment vérifier si une variable est de type fonction en JavaScript ?",
      options: ["typeof variable === 'function'", "isFunction(variable)", "functionType(variable)"],
      answer: 0,
    },
    {
      question: "Quelle méthode est utilisée pour ajouter des éléments au début d'un tableau ?",
    ...
    {
      question: "Comment copier un objet en JavaScript sans lien vers l'original ?",
    ...
    },
    {
      ...
      options: ["async function() {}", "function async() {}", "await function() {}"],
      answer: 0,
    },
  ];
